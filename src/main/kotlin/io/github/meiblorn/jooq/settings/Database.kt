...
sealed class Database : JdbcAware, SettingsElement {
    ...
    @get:Input abstract var username: String

    @get:Input abstract var password: String

    @get:Input abstract var name: String

    @get:Input abstract var port: Int

    @get:Nested internal abstract val jdbc: Jdbc
    ...
    data class Internal(
        ...
        internal fun getJdbcUrl(host: String, port: Int) =
