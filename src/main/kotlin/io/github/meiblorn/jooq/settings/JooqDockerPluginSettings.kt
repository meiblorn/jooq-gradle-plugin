...
import io.github.meiblorn.jooq.container.GenericDatabaseContainer
...
sealed class JooqDockerPluginSettings : SettingsElement {
    @get:Nested internal abstract val database: Database
    ...
    private constructor(
        ...
        constructor(
            customizer: Action<WithContainer> = Action<WithContainer> {}
        ...
        override fun copy(): WithContainer =
            WithContainer(
                database = database.run { copy(jdbc = jdbc.copy()) }, image = image.copy())
    ...
    class WithoutContainer private constructor(override val database: Database.External) :
        ...
        override fun copy(): WithoutContainer =
            WithoutContainer(database = database.run { copy(jdbc = jdbc.copy()) })
