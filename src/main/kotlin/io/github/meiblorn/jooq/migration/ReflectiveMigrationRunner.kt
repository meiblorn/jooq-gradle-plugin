...
internal class ReflectiveMigrationRunner(codegenAwareClassLoader: ClassLoader) : MigrationRunner {
    ...
    private class ReflectiveFlywayConfiguration(private val codegenAwareClassLoader: ClassLoader) {
        ...
        private val configurationClass =
            codegenAwareClassLoader.loadClass(FluentConfiguration::class.jvmName)
        ...
        fun dataSource(credentials: DatabaseCredentials) = also {
            val dataSourceMethod =
                configurationClass.getMethod(
                    ...
                    String::class.java,
                    String::class.java)
            dataSourceMethod.invoke(
                configuration, credentials.jdbcUrl, credentials.username, credentials.password)
        }
        ...
        fun schemas(vararg schemas: String) = also {
            val schemasMethod =
                configurationClass.getMethod(
                    twoArgFunctionName(FluentConfiguration::schemas), Array<String>::class.java)
        ...
        fun defaultSchema(schema: String) = also {
            val defaultSchemaMethod =
                configurationClass.getMethod(
                    twoArgFunctionName(FluentConfiguration::defaultSchema), String::class.java)
        ...
        fun table(table: String) = also {
            val tableMethod =
                configurationClass.getMethod(
                    twoArgFunctionName(FluentConfiguration::table), String::class.java)
        ...
        fun configuration(props: Map<String, String>) = also {
            val configurationMethod =
                configurationClass.getMethod(
                    twoArgFunctionName<
                        FluentConfiguration, Map<String, String>, FluentConfiguration>(
        ...
        fun load(): ReflectiveFlyway {
            ...
            return ReflectiveFlyway(
                ...
                migrateResultClass =
                    codegenAwareClassLoader.loadClass(MigrateResult::class.jvmName),
    ...
    private class ReflectiveFlyway(
        ...
        fun migrate(): SchemaVersion {
            ...
            val targetSchemaVersionProperty =
                migrateResultClass.getField(MigrateResult::targetSchemaVersion.name)
