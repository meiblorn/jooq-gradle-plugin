...
import io.github.meiblorn.jooq.settings.PropertiesReader
...
open class JooqDockerPlugin @Inject constructor(private val providerFactory: ProviderFactory) :
    Plugin<Project> {
            ...
            extensions.create<JooqExtension>(
                ...
                providerFactory.provider {
                    ...
                    project.properties.entries
                        .filter { (key, _) -> key.startsWith(PropertiesReader.PREFIX) }
            ...
            pluginManager.withPlugin("org.gradle.java") {
                extensions.findByType<JavaPluginExtension>()?.run {
                    sourceSets.named(MAIN_SOURCE_SET_NAME) {
                        java { srcDirs(tasks.withType<GenerateJooqClassesTask>()) }
                    }
                }
            }
        }
