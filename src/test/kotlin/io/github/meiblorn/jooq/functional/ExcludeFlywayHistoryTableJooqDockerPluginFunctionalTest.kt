...
class ExcludeFlywayHistoryTableJooqDockerPluginFunctionalTest :
    ...
    fun `should exclude flyway schema history by default`() {
        ...
        expect {
            ...
            that(
                    projectFile(
                        "build/generated-jooq/org/jooq/generated/tables/FlywaySchemaHistory.java"))
                .notExists()
        }
    }
    ...
    fun `should exclude flyway schema history given custom Flyway table name`() {
        ...
        expect {
            that(result).generateJooqClassesTask.outcome isEqualTo SUCCESS
            that(projectFile("build/generated-jooq/org/jooq/generated/tables/Foo.java")).exists()
            that(projectFile("build/generated-jooq/org/jooq/generated/tables/SomeSchemaTable.java"))
                .notExists()
        }
    }
    ...
    fun `should exclude flyway schema history without overriding existing excludes`() {
        ...
        expect {
            ...
            that(
                    projectFile(
                        "build/generated-jooq/org/jooq/generated/public_/tables/FlywaySchemaHistory.java"))
                .notExists()
        }
    }
}
