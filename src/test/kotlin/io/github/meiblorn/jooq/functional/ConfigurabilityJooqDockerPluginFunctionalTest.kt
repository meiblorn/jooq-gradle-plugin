...
class ConfigurabilityJooqDockerPluginFunctionalTest : JooqDockerPluginFunctionalTestBase() {
    ...
    fun `should generate jooq classes for PostgreSQL db with default config for multiple schemas`() {
        ...
        expect {
            ...
            that(projectFile("build/generated-jooq/org/jooq/generated/public_/tables/Foo.java"))
                .exists()
            that(projectFile("build/generated-jooq/org/jooq/generated/other/tables/Bar.java"))
                .exists()
        }
    }
    ...
    fun `should generate jooq classes for PostgreSQL db with default config for multiple schemas and renames package`() {
        ...
        expect {
            that(result).generateJooqClassesTask.outcome isEqualTo SUCCESS
            that(projectFile("build/generated-jooq/org/jooq/generated/fancy_name/tables/Foo.java"))
                .exists()
            that(projectFile("build/generated-jooq/org/jooq/generated/other/tables/Bar.java"))
                .exists()
        }
    ...
    fun `should generate jooq classes in a given package`() {
        ...
        expect {
            that(result).generateJooqClassesTask.outcome isEqualTo SUCCESS
            that(projectFile("build/generated-jooq/com/example/tables/Foo.java")).exists()
        }
    }
    ...
    fun `should pass output schema to default setting to jOOQ generator`() {
        ...
        expect {
            ...
            that(projectFile("build/generated-jooq/org/jooq/generated/DefaultSchema.java")).exists()
        }
    }
    ...
    fun `should respect outputDirectory task property`() {
        ...
        expect {
            that(result).generateJooqClassesTask.outcome isEqualTo SUCCESS
            that(projectFile("build/gen/org/jooq/generated/tables/Foo.java")).exists()
        }
    }
}
