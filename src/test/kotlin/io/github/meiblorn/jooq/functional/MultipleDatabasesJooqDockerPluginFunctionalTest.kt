...
class MultipleDatabasesJooqDockerPluginFunctionalTest : JooqDockerPluginFunctionalTestBase() {
    ...
    fun `should generate jooq classes for PostgreSQL and MySQL`() {
        ...
        copyResource(
            from = "/V01__init.sql", to = "src/main/resources/postgres/migration/V01__init.sql")
        copyResource(
            from = "/V01__init_mysql.sql", to = "src/main/resources/mysql/migration/V01__init.sql")
        ...
        expect {
            ...
            that(
                    projectFile(
                        "build/classes/java/main/org/jooq/generated/postgres/tables/Foo.class"))
                .exists()
            that(projectFile("build/classes/java/main/org/jooq/generated/mysql/tables/Foo.class"))
                .exists()
            that(
                    projectFile(
                        "build/classes/java/main/org/jooq/generated/mysql/tables/FlywaySchemaHistory.class"))
                .exists()
        }
    }
    ...
    fun `should be able generate jooq classes for internal and external databases`() {
        ...
        expect {
            that(result).generateJooqClassesTask.outcome isEqualTo SUCCESS
            that(projectFile("build/classes/java/main/org/jooq/generated/local/tables/Foo.class"))
                .exists()
            that(projectFile("build/classes/java/main/org/jooq/generated/remote/tables/Foo.class"))
                .exists()
            that(
                    projectFile(
                        "build/classes/java/main/org/jooq/generated/remote/tables/FlywaySchemaHistory.class"))
                .exists()
        }
    }
}
