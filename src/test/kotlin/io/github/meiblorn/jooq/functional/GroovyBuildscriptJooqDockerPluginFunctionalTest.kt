...
class GroovyBuildscriptJooqDockerPluginFunctionalTest : JooqDockerPluginFunctionalTestBase() {
    ...
    fun `should work with Groovy buildscript when running with a container`() {
        ...
        expect {
            ...
            that(projectFile("build/generated-jooq/org/jooq/generated/tables/Foo.java")).exists()
            that(projectFile("build/generated-jooq/org/jooq/generated/tables/Bar.java")).notExists()
        }
    }
    ...
    fun `should be able generate jooq classes for internal and external databases with Groovy buildscript`() {
        ...
        expect {
            that(result).generateJooqClassesTask.outcome isEqualTo SUCCESS
            that(projectFile("build/local/org/jooq/generated/local/tables/Foo.java")).exists()
            that(projectFile("build/remote/org/jooq/generated/remote/tables/Foo.java")).exists()
            that(
                    projectFile(
                        "build/remote/org/jooq/generated/remote/tables/FlywaySchemaHistory.java"))
                .exists()
        }
    }
}
