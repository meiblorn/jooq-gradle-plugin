...
class UpToDateChecksJooqDockerPluginFunctionalTest : JooqDockerPluginFunctionalTestBase() {
    ...
    fun `up to date check should work for input dir`() {
        ...
        copyResource(
            from = "/V02__add_bar.sql", to = "src/main/resources/db/migration/V02__add_bar.sql")
    ...
    fun `should regenerate jooq classes when out of date even if output directory already has classes generated`() {
        ...
        expect {
            ...
            that(projectFile("build/generated-jooq/org/jooq/generated/tables/Foo.java"))
                .exists()
                .get { readText() }
                .contains("com.example.UniqueClassForFirstGeneration")
        }
        ...
        expect {
            ...
            that(projectFile("build/generated-jooq/org/jooq/generated/tables/Foo.java"))
                .exists()
                .get { readText() }
                .contains("com.example.UniqueClassForSecondGeneration")
        }
    }
