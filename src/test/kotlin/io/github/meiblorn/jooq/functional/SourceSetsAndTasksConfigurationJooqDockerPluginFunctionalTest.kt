...
class SourceSetsAndTasksConfigurationJooqDockerPluginFunctionalTest :
    JooqDockerPluginFunctionalTestBase() {

    @TestFactory
    fun `should configure source sets and tasks for java project`() =
        sequenceOf(
        ...
        """.trimIndent())
            ...
            .map { (caseName, buildScript) ->
                dynamicTest("should configure source sets and tasks for java project $caseName") {
                    ...
                    copyResource(
                        from = "/V01__init.sql",
                        to = "src/main/resources/db/migration/V01__init.sql")
                ...
                """.trimIndent()
                    ...
                    expect {
                        ...
                        that(projectFile("build/generated-jooq/org/jooq/generated/tables/Foo.java"))
                            .exists()
                        that(projectFile("build/classes/java/main/com/test/Main.class")).exists()
                    }
                }
            }
            .asStream()
    ...
    @TestFactory
    fun `should configure source sets and tasks for kotlin project`() =
        sequenceOf(
            ...
            .map { (caseName, buildScript) ->
                ...
                """.trimIndent()
                    ...
                    expect {
                        ...
                        that(projectFile("build/generated-jooq/org/jooq/generated/tables/Foo.java"))
                            .exists()
                        that(projectFile("build/classes/kotlin/main/com/test/MainKt.class"))
                            .exists()
                    }
                }
            }
